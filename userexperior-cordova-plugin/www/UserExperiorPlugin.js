...
UserExperiorPlugin.stopRecording = function(resetAppSessionId, successCallback, errorCallback)
{
	return exec(successCallback, errorCallback, "UserExperiorPlugin", "stopRecording", [resetAppSessionId]);
};
